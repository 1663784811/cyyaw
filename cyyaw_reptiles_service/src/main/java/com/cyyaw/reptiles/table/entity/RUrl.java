...
@DynamicInsert
@Table(name = "r_url")
@org.hibernate.annotations.Table(appliesTo = "r_url", comment = "地址内容")
public class RUrl implements Serializable {
    private static final long serialVersionUID = 156818126273933758L;
    ...
    @Basic
    @Column(name = "url", columnDefinition = "varchar(255) COMMENT '爬取的地址'")
    private String url;
    @Basic
    @Column(name = "title", columnDefinition = "varchar(255) COMMENT '图片的标题'")
