...
@Data
@Entity
@Table(name = "e_photo_classification")
@org.hibernate.annotations.Table(appliesTo = "e_photo_classification", comment = "图片分类")
public class EPhotoClassification implements Serializable {
