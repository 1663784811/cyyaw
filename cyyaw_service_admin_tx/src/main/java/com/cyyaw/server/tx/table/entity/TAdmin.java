package com.cyyaw.server.tx.table.entity;
...
public class TAdmin implements Serializable {
    ...
    @Basic
    @Column(name = "createtime", length = 19, nullable = true, columnDefinition = "datetime default now() COMMENT '创建时间'")
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    ...
    private String note;
    @Basic
    @Column(name = "password", length = 64, nullable = true, columnDefinition = "varchar(64) COMMENT '密码'")
