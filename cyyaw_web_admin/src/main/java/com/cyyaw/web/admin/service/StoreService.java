...
public interface StoreService {
    ...
    @RequestMapping(value = "/store/admin/enterprise/delEEnterprise", produces = "application/json; charset=UTF-8")
    BaseResult delEEnterprise(@RequestBody JSONArray arr);


    @RequestMapping(value = "/store/admin/store/findPage", produces = "application/json; charset=UTF-8")
    BaseResult findPageStore(@RequestParam("page") Integer page, @RequestParam("size") Integer size);

    @RequestMapping(value = "/store/admin/store/saveStore", produces = "application/json; charset=UTF-8")
    BaseResult saveStore(@RequestBody JSONObject json);
}
